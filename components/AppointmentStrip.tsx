        ...
        >
          <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-[#051525] p-3 sm:p-4 shadow-[0_30px_60px_rgba(0,0,0,0.4)] flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="relative z-10 flex items-center gap-3 w-full sm:w-auto px-2">
              <div className="hidden sm:flex h-10 w-10 items-center justify-center rounded-full bg-secondary/10 text-secondary border border-secondary/20 shadow-[0_0_15px_rgba(100,255,218,0.15)]">
              ...
              <div className="flex-1 sm:flex-none">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all border ${selectedSlot === "Morning" ? 'bg-secondary/10 border-secondary/30 text-secondary shadow-[0_0_15px_rgba(100,255,218,0.15)]' : 'bg-white/5 border-white/5 text-[#a8b4cc] hover:bg-white/10 hover:text-white'}`}
                  >
                    Morning
                  </button>
                  <button 
                    onClick={() => setSelectedSlot("Evening")}
                    className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all border ${selectedSlot === "Evening" ? 'bg-secondary/10 border-secondary/30 text-secondary shadow-[0_0_15px_rgba(100,255,218,0.15)]' : 'bg-white/5 border-white/5 text-[#a8b4cc] hover:bg-white/10 hover:text-white'}`}
                  >
                    Evening
                  </button>
                </div>
            ...
            <button
              onClick={handleBook}
              className="relative z-10 w-full sm:w-auto overflow-hidden group flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-secondary to-[#38debb] px-6 py-3 text-sm font-bold tracking-wider text-[#051525] shadow-[0_0_20px_rgba(100,255,218,0.3)] hover:shadow-[0_0_30px_rgba(100,255,218,0.6)] transition-all active:scale-95"
            >
